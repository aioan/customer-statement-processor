...
class XmlParserTest {
  ...
  @Test
  void givenCorrectXmlFile_returnsExpectedOutput() throws IOException {
  ...
  @Test
  void givenMalformedXmlFile_throwInvalidFileStructureException() {
    XmlParser underTest = new XmlParser();

    underTest.initialise(getMalformedXmlFile());
  ...
  @Test
  void givenXmlFileWithMissingReference_throwInvalidFileStructureException() {
    XmlParser underTest = new XmlParser();

    underTest.initialise(getMissingReferenceXmlFile());
  ...
  @Test
  void givenXmlFileWithInvalidTags_throwInvalidFileStructureException() {
    XmlParser underTest = new XmlParser();

    underTest.initialise(getUnknownTagXmlFile());
  ...
  @Test
  void givenXmlFileWithInvalidAmount_throwInvalidFileStructureException() {
    XmlParser underTest = new XmlParser();

    underTest.initialise(getInvalidAmountXmlFile());
  ...
  private static InputStream getMalformedXmlFile() {
    return new ByteArrayInputStream("notAnXml".getBytes(Charset.forName("UTF-8")));
  }

  private static InputStream getMissingReferenceXmlFile() {
    return new ByteArrayInputStream(
        "<records><record></record></records>".getBytes(Charset.forName("UTF-8")));
  }
  
  private static InputStream getUnknownTagXmlFile() {
    return new ByteArrayInputStream(
        "<records><record reference=\"1\"><a></a></record></records>".getBytes(Charset.forName("UTF-8")));
  }
  
  private static InputStream getInvalidAmountXmlFile() {
    return new ByteArrayInputStream(
        "<records><record reference=\"1\"><endBalance>TEST</endBalance></record></records>".getBytes(Charset.forName("UTF-8")));
  }
